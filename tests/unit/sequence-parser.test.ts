...
import { parseSequence, isSequenceDiagram } from "../../src/parser/index.js";
import type { SequenceAST, SequenceMessage, SequenceNote } from "../../src/types/index.js";
...
describe("parseSequence - Activation", () => {
  it("should parse activate statement", () => {
    ...
    const activations = ast.statements.filter(s => s.type === "activate" || s.type === "deactivate");
